...
import { manifest as ruManifest } from "./ru-RU/manifest.ts";
import { ui as ruUi } from "./ru-RU/ui.ts";
...
export const localeRegistry = {
  ...
  "ru-RU": { displayName: "Русский", webExtensionLocale: "ru", ui: ruUi, manifest: ruManifest },
